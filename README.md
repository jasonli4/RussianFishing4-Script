...
一个专为《俄罗斯钓鱼4》设计的自动化钓鱼工具，集成AI编写的图形化界面，支持 手竿、水底、路亚、海图模式等多种钓鱼方式。
...
### 基本要求
- **分辨率**：仅支持1920x1080分辨率，桌面和游戏保持一致。
- **窗口模式**：仅支持全屏/无边框窗口。
- **语言支持**：仅支持简体中文界面及简体中文游戏界面。
- **游戏内鼠标设置**：鼠标灵敏度需为默认值。
- **游戏内画面设置**：画质全调最低，视野调到最大，曝光度调到最低。
- **模式切换**：切换模式后需先停止程序再启动。
...
**QQ群**：1033996413
(由于倒卖，github停止更新，最新版只在群内发布。为保证群的安全和素质，咸鱼下单才能入群，咸鱼用户名：hetufdxguuydse)
